...
public class GameSDK {
    		...
    		GameApp.getApp().runOnGLThread(new Runnable(){
    			public void run() {
					...
					case SdkListener.RET_PAY_FAIL:
						...
						break;
					case SdkListener.RET_USERCENTER:
						enterPlatformCb(1, sdk.getChannel());
						break;
					case SdkListener.RET_NO_USERCENTER:
						enterPlatformCb(0, sdk.getChannel());
						break;
					}
    			}
    		});
	...
	public static void pay(final String pid, final String pname, final String pdesc, final int pprice, 
			final int pcount, final int prate, final String uid, final String uname, final int ulevel, final int ubalance, final String serverId, final String serverName, final String ext)
    {
		_gameActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				req.put(LdSdk.SERVER_NAME, serverName);
	...
	public static native void enterPlatformCb(int flags, String channel);
