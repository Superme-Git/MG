...
public class Cocos2dxVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public void backupSeekPosition()
    {
    	mSeekWhenPrepared = getCurrentPosition();
    }
...
//    	Log.d("LJ", "Cocos2dxVideoView.onConfigurationChanged("+newConfig.orientation+")");
//    	
...
//	    fixSize();
    ...
    public void fixSize(int left, int top, int width, int height) {
        ...
        Log.d("LJ", "Cocos2dxVideoView.videoSize("+mVideoWidth+","+mVideoHeight+")");
        Log.d("LJ", "Cocos2dxVideoView.fixSize("+left+","+top+","+width+","+height+")");
        ...
        Log.d("LJ", "Cocos2dxVideoView.VisibleSize("+mVisibleLeft+","+mVisibleTop+","+mVisibleWidth+","+mVisibleHeight+")");
        ...
        if (parent != null && mVisibleTop > 0) {
        	TextView labelTop = new TextView(mCocos2dxActivity);
        	labelTop.setWidth(width);
        	labelTop.setHeight(mVisibleTop);
        	labelTop.setBackgroundColor(0xff000000);
        	labelTop.setY(0);
        	parent.addView(labelTop);
        	TextView labelBottom = new TextView(mCocos2dxActivity);
        	labelBottom.setWidth(width);
        	labelBottom.setHeight(mVisibleTop);
        	labelBottom.setBackgroundColor(0xff000000);
        	labelBottom.setY(height-mVisibleTop);
        	parent.addView(labelBottom);
        }
    }
    ...
    public static final int EVENT_TERMINATION = 4;
