...
public class GameApp extends Cocos2dxActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isUseDuCilnetSdk()){
			...
			Main.go(this, strMyChannelId, null);	
		}
...
//				}
	...
	public static void tdInit(){
		String sTDAppId = "";
		try {
			ApplicationInfo appinfo = gameApp.getPackageManager().getApplicationInfo(gameApp.getPackageName(), PackageManager.GET_META_DATA);
			sTDAppId = appinfo.metaData.getString("td_appid");
		} catch (NameNotFoundException e) {
			e.printStackTrace();
			sTDAppId = "not define td_appid";
		}
		
		TalkingDataAppCpa.init(gameApp.getApplicationContext(), sTDAppId, strMyChannelId);
	}
    /**
