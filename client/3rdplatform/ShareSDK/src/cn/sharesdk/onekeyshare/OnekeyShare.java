...
public class OnekeyShare {
	...
	public final static int SHARE_SUCCEED = 98;
	public final static int SHARE_FAILED = 99;
	public final static int SHARE_CANCELED = 100;
	...
	public void show(Context context, Callback callback) {
		...
		themeImpl.show(context, callback);
	}
