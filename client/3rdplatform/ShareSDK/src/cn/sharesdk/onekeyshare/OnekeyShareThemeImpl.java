...
public abstract class OnekeyShareThemeImpl implements PlatformActionListener, Callback {
	...
	public final void onComplete(Platform platform, int action,
		...
		Log.e("mt3", "OnekeyShareThemeImpl onComplete ... ");
	...
	public final void onError(Platform platform, int action, Throwable t) {
		Log.e("mt3", "OnekeyShareThemeImpl onError ... ");
		t.printStackTrace();
	...
	public final void onCancel(Platform platform, int action) {
		Log.e("mt3", "OnekeyShareThemeImpl onCancel ... ");
		Message msg = new Message();
		msg.arg1 = 3;
		msg.arg2 = action;
		msg.obj = platform;
	...
	public final boolean handleMessage(Message msg) {
		switch (msg.arg1) {
			case 1: {
				...
				Message msg_callback = new Message();
				msg_callback.what = OnekeyShare.SHARE_SUCCEED;
				msg_callback.arg1 = 1;
				UIHandler.sendMessage(msg_callback, this.m_callback);
			} break;
			case 2: {
				// 失败
				...
				Message msg_callback = new Message();
				msg_callback.what = OnekeyShare.SHARE_FAILED;
				msg_callback.arg1 = 1;
				UIHandler.sendMessage(msg_callback, this.m_callback);
			} break;
			case 3: {
				...
				Message msg_callback = new Message();
				msg_callback.what = OnekeyShare.SHARE_CANCELED;
				msg_callback.arg1 = 1;
				UIHandler.sendMessage(msg_callback, this.m_callback);
			} break;
		}
