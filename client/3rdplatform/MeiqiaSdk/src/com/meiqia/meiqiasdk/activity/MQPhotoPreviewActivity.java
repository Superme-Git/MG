...
public class MQPhotoPreviewActivity extends Activity implements PhotoViewAttacher.OnViewTapListener, View.OnClickListener {
     ...
     *
     * @param context
     * @param saveImgDir      淇濆瓨鍥剧墖鐨勭洰褰曪紝濡傛灉浼爊ull锛屽垯娌℃湁淇濆瓨鍥剧墖鍔熻兘
     * @param previewImages   褰撳墠棰勮鐨勫浘鐗囩洰褰曢噷鐨勫浘鐗囪矾寰勯泦鍚�
     * @param currentPosition 褰撳墠棰勮鍥剧墖鐨勪綅缃�
     * @return
     */
    ...
    private void processLogic(Bundle savedInstanceState) {
        ...
        if (mIsSinglePreview) {
            mPreviewImages = new ArrayList<String>();
            ...
            public void onLoadingComplete(String imageUri, View view, final Bitmap loadedImage) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            // 閫氳繃MD5鍔犲瘑url鐢熸垚鏂囦欢鍚嶏紝閬垮厤澶氭淇濆瓨鍚屼竴寮犲浘鐗�
