...
注意：所有“v140（VS2015）”相关内容已迁入归档目录：[docs/archive/v140相关文档](./archive/v140相关文档)。本指南仅覆盖 v120 主线。
...
归档说明：
- v140（VS2015）相关内容仅保留在 [docs/archive/v140相关文档](./archive/v140相关文档)，不作为主线编译参考。
