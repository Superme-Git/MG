...
namespace Nuclear
{
	...
	NuclearOStream& pslgroupobject::marshal(NuclearOStream &os) const
	{
		os << (int)CURVER;
	...
	const INuclearStream& pslgroupobject::unmarshal(const INuclearStream &os)
	{
		int nVer;
		os >> nVer;
