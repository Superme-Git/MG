...
namespace Nuclear
{
	...
	NuclearOStream& CPsParamObject::marshal(NuclearOStream &os) const
	{
		os << (int)CURVER;
	...
	const INuclearStream& CPsParamObject::unmarshal(const INuclearStream &os)
	{
		int nVer;
		os >> nVer;
