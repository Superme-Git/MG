#ifndef __Nuclear_IFONTMANAGER_H__
#define __Nuclear_IFONTMANAGER_H__
...
namespace Nuclear
{
	...
	public:
		...
		virtual void Render( Renderer& renderer, float x, float y, const NuclearFRectt* src) = 0;
		virtual void Render( Renderer* renderer, const NuclearFPoint& textPos, const NuclearFPoint& fScale, const NuclearFRectt* src) = 0;
	};
	...
	public:
		...
		virtual bool AddFontType(int fontType, LPCTSTR fontFile, int fontSize, LPCTSTR defFontFile, int defFontSize, int defFontType) = 0;
        ...
        virtual CFontTexPool*	GetFontTexturePool() = 0;
