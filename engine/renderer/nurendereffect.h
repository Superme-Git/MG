...
namespace Nuclear
{
	...
	/////////////////////////////////////////
	class TBRenderEffect : public RenderEffect 
	{ 
	public:
		XPTextureBlendParam param; //fcoef
	private:
	...
	public:
		...
		{
			param = *static_cast<const XPTextureBlendParam*>(pParam);
		}
	};
	...
	public:
		...
		virtual void ChangeShaderParam(const void* pParam)
		{
			param = *static_cast<const sPAlphaParam*>(pParam);
		}
	};
