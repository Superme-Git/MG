...
namespace Nuclear
{
	...
	void ListEffect::SetScaleType(Nuclear_EffectScaleType t)
	{
		if (m_scaleType != t)
		{
			m_scaleType = t;
	...
	Nuclear_EffectAssureResResult ListEffect::AssureResource(bool async) 
	{ 
		if (m_state != XPES_EMPTY)
	...
	Nuclear_EffectBindType ListEffect::GetEffectBindType() const
	{
	...
	void ListEffect::Clone(Effect* p)
	{
	}
}
