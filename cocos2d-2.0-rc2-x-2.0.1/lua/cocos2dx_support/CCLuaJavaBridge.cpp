...
{
	return cocos2d::CCScriptEngineManager::sharedManager()->getScriptEngine()->executeFunctionWithStringData(functionId, arg);
//	lua_State *L = s_luaState;
...
{
	return cocos2d::CCScriptEngineManager::sharedManager()->getScriptEngine()->executeGlobalFunctionWithStringData(functionName, arg);
/*
    lua_State *L = s_luaState;
