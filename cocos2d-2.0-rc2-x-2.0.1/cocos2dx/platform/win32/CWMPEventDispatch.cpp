...
enum PlayState
{
	...
	PlayState_Paused,
	PlayState_Playing,
	PlayState_ScanForward,
	PlayState_ScanReverse,
	PlayState_Buffering,
	PlayState_Waiting,
...
static const TCHAR* PlayStateTexts[] =
{
	_T("PlayState_Undefined"),
	_T("PlayState_Stopped"),
	_T("PlayState_Paused"),
	_T("PlayState_Playing"),
	_T("PlayState_ScanForward"),
	_T("PlayState_ScanReverse"),
	_T("PlayState_Buffering"),
	_T("PlayState_Waiting"),
	_T("PlayState_MediaEnded"),
	_T("PlayState_Transitioning"),
	_T("PlayState_Ready"),
	_T("PlayState_Reconnecting"),
};
...
void CWMPEventDispatch::setView(CWMPView* pView)
{
	mpView = pView;
}
...
void CWMPEventDispatch::PlayStateChange(long NewState)
{
	switch(NewState)
	{
	case PlayState_Stopped: if(mpView) mpView->onStopped(); break;
	case PlayState_Paused: if(mpView) mpView->onPaused(); break;
	case PlayState_Playing: if(mpView) mpView->onPlaying(); break;
	case PlayState_MediaEnded: if(mpView) mpView->onCompleted(); break;
	}
	return;
}
...
void CWMPEventDispatch::DoubleClick( short /*nButton*/, short /*nShiftState*/, long /*fX*/, long /*fY*/ )
{
	//if(mpView)
	//{
	//	mpView->setFullscreen(!mpView->isFullscreen());
	//}
