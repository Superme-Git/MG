...
class Texture : public RefCountObject
{
  ...
  protected:
    ...
    bool subImage(GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLint unpackAlignment, 
		const void *pixels, rx::Image *image);
...
class Texture2D : public Texture
{
  public:
    ...
    void subImage(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLint unpackAlignment,
		const void *pixels, GLboolean force = false);
  ...
  private:
    ...
    void commitRect(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLboolean force = false);
