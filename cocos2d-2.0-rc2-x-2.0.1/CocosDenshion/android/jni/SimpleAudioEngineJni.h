...
extern "C"
{
	...
	extern bool getEffectIsPlayingJNI(const char* path);
    extern void endJNI();
	...
	extern void setEffectVolumeJNI(unsigned int nSoundId, float fVolume);
	extern bool hasEffectJNI(unsigned int nSoundId);
	extern bool isEffectPlayingJNI(unsigned int nSoundId);
}
