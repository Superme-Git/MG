...
<?php include APPPATH . "views/_menu_serverlist.php";?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">微博评论列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                    	...
                    	<div class="panel-body">
							...
							<tbody>
								...
								<tr class="odd ">
									<td><?php echo $item['status_comment_id']?></td>
...
<!--										<a href="/index/edit?serverlist_id=<?php //echo $item['serverlist_id']?>" class="btn btn-primary">编辑</a>-->
										<a href="javascript:;" onclick="return redirect_confirm('/comment/del/<?php //echo $item['serverlist_id']?>')" class="btn btn-warning">删除</a>
									</td>
								</tr>
								<?php }?>
								<tr class="odd">
