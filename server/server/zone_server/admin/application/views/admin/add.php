					...
					<div class="panel-body">
						<div class="col-md-9">
							<div class="form-group ">
								...
								<input type="text" class="form-control" id="email" name="email" value="<?php echo !empty($olddata['email']) ? $olddata['email'] : ''?>">
							</div>
							<div class="form-group ">
							...
							<div class="form-group ">
								...
								<select name="role" class="form-control">
									...
									<option value="<?php echo $k?>" <?php echo !empty($olddata['role']) && $olddata['role'] == $k ? 'selected' : ''?>><?php echo $v?></option>
                                    <?php }?>
								</select>
							</div>
						</div>
