...
class Role_attribute_model extends MY_Model
{
	...
	public function get_withrepair($roleid)
	{
		...
		if ($attribute_info)
		{
		    $attribute_info['signature'] = (string)$attribute_info['signature'];
		    $attribute_info['popularity_count'] = (string)$attribute_info['popularity_count'];
		    $attribute_info['gift_count'] = (string)$attribute_info['gift_count'];
