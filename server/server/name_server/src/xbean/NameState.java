...
public interface NameState extends mkdb.Bean {
	...
	public com.locojoy.base.Octets getPeeripOctets(); // 名字分配的远端服务器地址
	...
	public void setPeeripOctets(com.locojoy.base.Octets _v_); // 名字分配的远端服务器地址
