...
public class Clan {
	...
	public static xbean.NameState get(String key) {
		return _Tables_.getInstance().clan.get(key);
	}

	public static xbean.NameState get(String key, xbean.NameState value) {
		return _Tables_.getInstance().clan.get(key, value);
	}

	public static void insert(String key, xbean.NameState value) {
		_Tables_.getInstance().clan.insert(key, value);
	}

	public static void delete(String key) {
		_Tables_.getInstance().clan.delete(key);
	}

	public static boolean add(String key, xbean.NameState value) {
		return _Tables_.getInstance().clan.add(key, value);
	}

	public static boolean remove(String key) {
		return _Tables_.getInstance().clan.remove(key);
	}

	public static mkdb.TTableCache<String, xbean.NameState> getCache() {
		return _Tables_.getInstance().clan.getCache();
	}

	public static mkdb.TTable<String, xbean.NameState> getTable() {
		return _Tables_.getInstance().clan;
	}

	public static xbean.NameState select(String key) {
		return getTable().select(key, new mkdb.TField<xbean.NameState, xbean.NameState>() {
			public xbean.NameState get(xbean.NameState v) { return v.toData(); }
		});
	}

	public static Integer selectState(String key) {
		return getTable().select(key, new mkdb.TField<xbean.NameState, Integer>() {
	...
	public static String selectPeerip(String key) {
		return getTable().select(key, new mkdb.TField<xbean.NameState, String>() {
				public String get(xbean.NameState v) { return v.getPeerip(); }
			});
	}

	public static Long selectTime(String key) {
		return getTable().select(key, new mkdb.TField<xbean.NameState, Long>() {
