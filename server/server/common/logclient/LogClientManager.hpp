...
class LogClientManager : public GNET::Protocol::Manager
{
	static LogClientManager instance;
...
public:
	static LogClientManager *GetInstance() { return &instance; }
	virtual std::string Identification() const  { return "LogClientManager"; }
	void SetAccumulate(size_t size)     { accumulate_limit = size; }
	LogClientManager()
		: accumulate_limit(0), conn_state(false)
		, locker_state("LogClientManager::locker_state")
