					...
					<div class="panel-body">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="title" name="title" value="<?php echo isset($info['title']) ? $info['title'] : '' ?>">
							</div>
							<div class="form-group">
								<label class="control-label" for="style">样式</label>
								<input type="text" class="form-control" id="style" name="style" value="<?php echo isset($info['style']) ? $info['style'] : '' ?>">
							</div>
							<div class="form-group">
								...
								<select class="form-control" id="category_id" name="category_id">
                                    ...
                                    <option value="<?php echo $item['category_id']?>" <?php echo isset($info['category_id']) && $info['category_id'] == $item['category_id'] ? 'selected' : '' ?>>
                                    	<?php echo $item['name']?>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="keywords" name="keywords" value="<?php echo isset($info['keywords']) ? $info['keywords'] : '' ?>">
							...
							<div class="form-group">
								...
								<textarea name="content" style="width:100%;height:400px;"><?php echo isset($info['content']) ? $info['content'] : ''?></textarea>
							</div>
