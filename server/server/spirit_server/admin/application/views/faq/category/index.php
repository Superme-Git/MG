                    	...
                    	<div class="panel-body">
							...
							<tbody>
								...
								<tr class="odd ">
									...
									<td>
										<a href="/faq/category/edit?category_id=<?php echo $item['category_id']?>" class="btn btn-default">编辑</a>
										<a href="javascript:;" onclick="return redirect_confirm('/faq/category/del?category_id=<?php echo $item['category_id']?>')" class="btn btn-default">删除</a>
									</td>
								</tr>
								<?php }?>
								<tr class="odd">
