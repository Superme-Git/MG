...
public final class UserInfo extends mkdb.XBean implements xbean.UserInfo {
	private String plat; // 
	...
	UserInfo(int __, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
		plat = "";
		uid = "";
	}
	...
	UserInfo(xbean.UserInfo _o1_, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	...
	public final OctetsStream marshal(OctetsStream _os_) {
		_xdb_verify_unsafe_();
		_os_.marshal(plat, mkdb.Const.IO_CHARSET);
		_os_.marshal(uid, mkdb.Const.IO_CHARSET);
		return _os_;
	}
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		_xdb_verify_unsafe_();
		plat = _os_.unmarshal_String(mkdb.Const.IO_CHARSET);
		uid = _os_.unmarshal_String(mkdb.Const.IO_CHARSET);
		return _os_;
	}
	...
	public com.locojoy.base.Octets getPlatOctets() { // 
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getPlat(), mkdb.Const.IO_CHARSET);
	}
	...
	public com.locojoy.base.Octets getUidOctets() { // 实际就是username，account，platformUID
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getUid(), mkdb.Const.IO_CHARSET);
	}
	...
	public void setPlat(String _v_) { // 
		...
		mkdb.Logs.logIf(new mkdb.LogKey(this, "plat") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogString(this, plat) {
	...
	public void setPlatOctets(com.locojoy.base.Octets _v_) { // 
		_xdb_verify_unsafe_();
		this.setPlat(_v_.getString(mkdb.Const.IO_CHARSET));
	}
	...
	public void setUid(String _v_) { // 实际就是username，account，platformUID
		...
		if (null == _v_)
			throw new NullPointerException();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "uid") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogString(this, uid) {
	...
	public void setUidOctets(com.locojoy.base.Octets _v_) { // 实际就是username，account，platformUID
		_xdb_verify_unsafe_();
		this.setUid(_v_.getString(mkdb.Const.IO_CHARSET));
	}
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("plat"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("uid"));
		return lb;
	}
