...
public final class LocojoyPlatOrderInfo extends mkdb.XBean implements xbean.LocojoyPlatOrderInfo {
	...
	LocojoyPlatOrderInfo(int __, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
		orderserialplat = "";
		orderserialgame = "";
		username = "";
	...
	LocojoyPlatOrderInfo(xbean.LocojoyPlatOrderInfo _o1_, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	...
	public final OctetsStream marshal(OctetsStream _os_) {
		...
		_os_.marshal(orderserialplat, mkdb.Const.IO_CHARSET);
		_os_.marshal(orderserialgame, mkdb.Const.IO_CHARSET);
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		orderserialplat = _os_.unmarshal_String(mkdb.Const.IO_CHARSET);
		orderserialgame = _os_.unmarshal_String(mkdb.Const.IO_CHARSET);
	...
	public com.locojoy.base.Octets getOrderserialplatOctets() { // 
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getOrderserialplat(), mkdb.Const.IO_CHARSET);
	}
	...
	public com.locojoy.base.Octets getOrderserialgameOctets() { // 
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getOrderserialgame(), mkdb.Const.IO_CHARSET);
	}
	...
	public <T extends com.locojoy.base.Marshal.Marshal> T getVars(T _v_) { // 
		_xdb_verify_unsafe_();
		try {
			_v_.unmarshal(OctetsStream.wrap(com.locojoy.base.Octets.wrap(vars)));
			return _v_;
	...
	public void setOrderserialplat(String _v_) { // 
		...
		mkdb.Logs.logIf(new mkdb.LogKey(this, "orderserialplat") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogString(this, orderserialplat) {
	...
	public void setOrderserialplatOctets(com.locojoy.base.Octets _v_) { // 
		_xdb_verify_unsafe_();
		this.setOrderserialplat(_v_.getString(mkdb.Const.IO_CHARSET));
	}
	...
	public void setOrderserialgame(String _v_) { // 
		...
		if (null == _v_)
			throw new NullPointerException();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "orderserialgame") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogString(this, orderserialgame) {
	...
	public void setOrderserialgameOctets(com.locojoy.base.Octets _v_) { // 
		_xdb_verify_unsafe_();
		this.setOrderserialgame(_v_.getString(mkdb.Const.IO_CHARSET));
	}
	...
	public void setVars(com.locojoy.base.Marshal.Marshal _v_) { // 
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "vars") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogObject<byte []>(this, vars) {
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("orderserialplat"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("orderserialgame"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("username"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("vars"));
		return lb;
	}
