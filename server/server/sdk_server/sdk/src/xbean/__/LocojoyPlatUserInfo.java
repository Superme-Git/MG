...
public final class LocojoyPlatUserInfo extends mkdb.XBean implements xbean.LocojoyPlatUserInfo {
	...
	LocojoyPlatUserInfo(int __, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	}
	...
	LocojoyPlatUserInfo(xbean.LocojoyPlatUserInfo _o1_, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	...
	public void setUserinfoid(long _v_) { // users表里的key
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "userinfoid") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogLong(this, userinfoid) {
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("userinfoid"));
		return lb;
	}
