...
public final class Pod {
	public static mkdb.util.BeanPool<UserInfo> poolUserInfo = new mkdb.util.BeanPool<UserInfo>() {
		@Override
	...
	public static void padd(UserInfo bean) {
		mkdb.Procedure.padd(bean, poolUserInfo);
	}
	...
	public static mkdb.util.BeanPool<LocojoyPlatUserInfo> poolLocojoyPlatUserInfo = new mkdb.util.BeanPool<LocojoyPlatUserInfo>() {
		@Override
	...
	public static void padd(LocojoyPlatUserInfo bean) {
		mkdb.Procedure.padd(bean, poolLocojoyPlatUserInfo);
	}
	...
	public static mkdb.util.BeanPool<LocojoyPlatOrderInfo> poolLocojoyPlatOrderInfo = new mkdb.util.BeanPool<LocojoyPlatOrderInfo>() {
		@Override
	...
	public static void padd(LocojoyPlatOrderInfo bean) {
		mkdb.Procedure.padd(bean, poolLocojoyPlatOrderInfo);
	}
