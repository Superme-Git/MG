...
public class Locojoyplatorderinfos {
	...
	public static mkdb.TTableCache<String, xbean.LocojoyPlatOrderInfo> getCache() {
		return _Tables_.getInstance().locojoyplatorderinfos.getCache();
	}

	public static mkdb.TTable<String, xbean.LocojoyPlatOrderInfo> getTable() {
		return _Tables_.getInstance().locojoyplatorderinfos;
	}

	public static xbean.LocojoyPlatOrderInfo select(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatOrderInfo, xbean.LocojoyPlatOrderInfo>() {
	...
	public static Long selectCreatetime(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatOrderInfo, Long>() {
				public Long get(xbean.LocojoyPlatOrderInfo v) { return v.getCreatetime(); }
			});
	}

	public static String selectOrderserialplat(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatOrderInfo, String>() {
	...
	public static byte [] selectVars(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatOrderInfo, byte []>() {
