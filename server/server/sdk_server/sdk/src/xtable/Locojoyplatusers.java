...
public class Locojoyplatusers {
	...
	public static mkdb.TTableCache<String, xbean.LocojoyPlatUserInfo> getCache() {
		return _Tables_.getInstance().locojoyplatusers.getCache();
	}

	public static mkdb.TTable<String, xbean.LocojoyPlatUserInfo> getTable() {
		return _Tables_.getInstance().locojoyplatusers;
	}

	public static xbean.LocojoyPlatUserInfo select(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatUserInfo, xbean.LocojoyPlatUserInfo>() {
	...
	public static Integer selectUserid(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatUserInfo, Integer>() {
				public Integer get(xbean.LocojoyPlatUserInfo v) { return v.getUserid(); }
			});
	}

	public static Long selectUserinfoid(String key) {
		return getTable().select(key, new mkdb.TField<xbean.LocojoyPlatUserInfo, Long>() {
