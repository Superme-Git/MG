...
public:
	...
	public:
		...
		const OctetsStream& operator >> (unsigned char &x) const
		{
			x = pop_byte_8();
			return *this;
		}
		const OctetsStream& operator >> (bool &x) const
		{
			x = pop_byte_8();
			return *this;
		}
		const OctetsStream& operator >> (short &x) const
		{
			x = pop_byte_16();
			return *this;
		}
		const OctetsStream& operator >> (unsigned short &x) const
		{
			x = pop_byte_16();
			return *this;
		}
		const OctetsStream& operator >> (int &x) const
		{
			x = pop_byte_32();
			return *this;
		}
		const OctetsStream& operator >> (unsigned int &x) const
		{
			x = pop_byte_32();
			return *this;
		}
		...
		*/
		const OctetsStream& operator >> (int64_t &x) const
		{
			x = pop_byte_64();
			return *this;
		}
	
		const OctetsStream& operator >> (uint64_t &x) const
		{
			x = pop_byte_64();
			return *this;
		}
		/*
		const OctetsStream& operator >> (unsigned long long &x) const
		{
			x = pop_byte_64();
			return *this;
		}
		*/
		const OctetsStream& operator >> (float &x) const
		{
			...
			x = aliasing_cast<float>(l);
			return *this;
		}
		const OctetsStream& operator >> (double &x) const
		{
			unsigned long ll = pop_byte_64();
			x = aliasing_cast<double>(ll);
			return *this;
		}
		...
		template<typename T1, typename T2>
		const OctetsStream& operator >> (std::pair<const T1, T2> &x) const
		{
