...
public class EnumWrapper extends ObjectWrapper {

	EnumWrapper(String name, Object object, ObjectWrapper parent, Object key) {
	...
	public String toCommandView(int tabCount) {
		...
		if(varValue == null) 
			return "Enum " + varName + " = null";
		return tabString + varValue.getClass().getName() + " " + varName + " = " + varValue.toString();
	}
