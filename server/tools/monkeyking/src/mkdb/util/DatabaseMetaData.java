...
/**
 * 包含 mkdb 数据库信息。包含所有表格(table)和数据结构(xbean and cbean)。
 * <p>
 * mkgen 生成 DatabaseMetaData 子类 xtable._DatabaseMetaData_。
 * <p>
...
public class DatabaseMetaData {
	...
	/**
	 * mkdb.xml 中定义的所有 bean，包括 xbean 和 cbean。
	 */
	...
	/**
	 * 是否启用了 mkdb 的校验。
	 * mkgen 生成代码时根据选项会生成校验代码，用来检测程序是否扩越事务使用 xbean。
	 * mkgen 生成 _DatabaseMetaData_.java 时，重载这个函数。
