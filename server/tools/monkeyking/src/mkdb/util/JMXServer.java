...
public class JMXServer {
	...
	public static void premain(String agentArgs) throws IOException {
    	...
    	final int rmiport     = getPropertyInt("mkdb.util.jmxserver.rmi.port", 1098);
		final int serverport  = getPropertyInt("mkdb.util.jmxserver.port", rmiport + 1);
		final String hostname = System.getProperty("java.rmi.server.hostname") == null ? "127.0.0.1" : null;
		final String password = System.getProperty("mkdb.util.jmxserver.password.file");
		final String access   = System.getProperty("mkdb.util.jmxserver.access.file");
	...
	public static void main(String args[]) throws Exception {
		...
		try {
			...
			mkdb.util.MBeans.Manager manager = new mkdb.util.MBeans.Manager();
