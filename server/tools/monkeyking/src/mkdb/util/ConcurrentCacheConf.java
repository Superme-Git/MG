...
public class ConcurrentCacheConf {
	...
	public ConcurrentCacheConf(Element self) {
		...
		capacity = MkdbConf.getInt(self, "capacity", DEFAULT_CACHE_CAPACITY);
		hourOfDay = MkdbConf.getInt(self, "hourOfDay", DEFAULT_CLEAN_HOUR_OF_DAY);
		minute = MkdbConf.getInt(self, "minute", DEFAULT_CLEAN_MINUTE);
	}
