...
public class ConstNavigableMap<K, V>
	...
	public final K higherKey(K key) {
		return mkdb.Consts.toConst(w.higherKey(key));
	}
	...
	public final K lowerKey(K key) {
		return mkdb.Consts.toConst(w.lowerKey(key));
	}
	...
	public final K ceilingKey(K key) {
		return mkdb.Consts.toConst(w.ceilingKey(key));
	}
	...
	public final K floorKey(K key) {
		return mkdb.Consts.toConst(w.floorKey(key));
	}
