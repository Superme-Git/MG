...
//		}
	...
	/*
	 * 是否允许备份。 启动前设置有效。 启动以后使用 CheckpointMBean 进行修改。
	 */
	 ...
	 * 设置 checkpoint 定时间隔。
	 * <p>
	 * 可以在运行时修改。修改的间隔在完成一次checkpoint以后生效。
	 * 
	...
	/**
	 * flush锁之前执行并发 marshalN 的次数。默认为 1。 <b> 警告: 配置小于 1 时，记录系列化在 marshal0
	 * 中完成，这将加大flush锁定的时间。 <b> 运行时修改有效。
	 * 
	 * @see mkdb.Checkpoint
	 */
	...
	/**
	 * 自动 marshal 的时间间隔。 用于测试。运行时修改有效。 <=0 关闭自动 Marshal。
	 */
	...
	/**
	 * 设置备份延迟。 在mkdb启动之前设置，启动之后的这段延迟时间内，mkdb不会进行备份。 启动之后设置将无效
	 * 
	 * @param backupDelay
	 */
