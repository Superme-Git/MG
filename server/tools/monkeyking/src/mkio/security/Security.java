...
public abstract class Security implements Cloneable {
	...
	/*
	 * 以下为iolib的jni版本的Security接口，开放只是用于测试用。需要有相应的MkioSecurity.dll支持，暂不开放应用
	 * 其中compress接口，是用于Compress类封装 //enum { RANDOM = 0, NULLSECURITY = 1,
	 * ARCFOURSECURITY = 2, MD5HASH = 3, HMAC_MD5HASH = 4, //
