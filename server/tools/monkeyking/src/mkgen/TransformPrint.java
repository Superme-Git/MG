...
public class TransformPrint {
	...
	public void printMain()
	{
		...
		ps.println("import com.locojoy.base.Octets;");
		ps.println("import com.locojoy.base.Marshal.OctetsStream;");

		ps.println("import mkdb.util.DatabaseMetaData;");
		ps.println("import mkdb.util.Dbx;");
		...
		ps.println("	mkdb.util.Dbx.start(libpath);");
...
//		ps.println("				e.printStackTrace();}");
		...
		ps.println("	mkdb.util.Dbx.stop();");

		ps.println("}");

		ps.println("	static class Walker implements mkdb.Storage.IWalk {");
		...
		ps.println("	static class WalkerRaw implements mkdb.Storage.IWalk {");
