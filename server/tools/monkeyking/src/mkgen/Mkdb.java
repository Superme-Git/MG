...
public class Mkdb {
	...
	/**
	 * return : true :表示新旧的mkdb表内容有更改，需要transform false:
	 * 表示新旧的mkdb表内容没有更改，不需要xtransform
	 */
	...
	void transformMake() {
		...
		for (XBean bean : xbeans) { // 遍历所有的xbean
	...
	/**
	 * 2015.0902修改了生成_DatabaseMetaData_类的构造方法，主要是为了解决java编译时候出现的代码过长的错误
	 * 
	 * @param xbeans
	 * @param cbeans
	 * @param tables
