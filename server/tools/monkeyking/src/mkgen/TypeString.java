...
public class TypeString extends Type {
	...
	public void unmarshal(XBean bean, Variable var, PrintStream ps, String prefix, String localvarname) {
		ps.println(prefix + localvarname + " = _os_.unmarshal_String(mkdb.Const.IO_CHARSET);");
	}

	@Override
	public void marshal(XBean bean, Variable var, PrintStream ps, String prefix, String localvarname) {
		ps.println(prefix + "_os_.marshal(" + localvarname + ", mkdb.Const.IO_CHARSET);");
	}
	...
	public void getterInterface(XBean bean, Variable var, PrintStream ps, String prefix) {
		...
		ps.println(prefix + "public com.locojoy.base.Octets get" + var.getName() + "Octets(); // " + var.getComment());
	}

	@Override
	public void getter(XBean bean, Variable var, PrintStream ps, String prefix) {
		if (null != bean) // cbean 没有 interface
		...
		ps.println(prefix + "public com.locojoy.base.Octets get" + var.getName() + "Octets() { // " + var.getComment());
		Main._xdb_verify_(ps, prefix + "	");
		ps.println(prefix + "	return com.locojoy.base.Octets.wrap(get" + var.getName() + "(), mkdb.Const.IO_CHARSET);");
		ps.println(prefix + "}");
		ps.println("");
	}
	...
	public void setterInterface(XBean bean, Variable var, PrintStream ps, String prefix) {
		...
		ps.println(prefix + "public void set" + var.getName() + "Octets(com.locojoy.base.Octets _v_); // " + var.getComment());
	}
	...
	public void setter(XBean bean, Variable var, PrintStream ps, String prefix) {
		...
		ps.println(prefix + "			return new mkdb.logs.LogString(this, " + var.getname() + ") {");
		...
		ps.println(prefix + "public void set" + var.getName() + "Octets(com.locojoy.base.Octets _v_) { // " + var.getComment());
		Main._xdb_verify_(ps, prefix + "	");
		ps.println(prefix + "	this.set" + var.getName() + "(_v_.getString(mkdb.Const.IO_CHARSET));");
		ps.println(prefix + "}");
		ps.println();
	}
