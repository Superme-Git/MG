// dummyWinApp.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "dummyWinApp.h"
#include <TlHelp32.h>
...
public:
	GlobalObj()
	{
		MessageBox(NULL, _T("Hello world"), _T("GlobalObj"), MB_OK);
	}
};

static GlobalObj gObj;
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_DUMMYWINAPP, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DUMMYWINAPP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DUMMYWINAPP));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_DUMMYWINAPP);
