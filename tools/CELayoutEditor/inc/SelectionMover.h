...
public:
	...
	void UpdateWindowAreas(float left, float top, float right, float bottom, bool addUndoList = true);
	...
	void SetBoolMove(bool bmove){ mBoolMove = bmove; }
	bool GetBoolMove(){ return mBoolMove; }
