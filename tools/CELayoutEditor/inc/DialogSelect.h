...
#ifndef _DIALOG_SELECT_WINDOWS_H_
#define _DIALOG_SELECT_WINDOWS_H_
...
*/
class DialogSelect : public wxDialog
{
...
public:
    ...
    /* Constructor.*/
	DialogSelect(wxWindow* aParentDialog, const wxArrayString& choices);
    ...
    */
	...
	wxString& GetLayout(){ return m_selectLayout; }
...
private:
	...
	wxListBox* m_widgetTree;

	wxString m_selectLayout;
    ...
    * are not dependent on parents (true).*/
	...
	//void OnSelchangedWidgetTree(wxCommandEvent& event);
