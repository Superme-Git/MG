...
namespace CSTools
{
    public class ToolsIni
    {
        ...
        public bool LoadFromFile(string FullFileName)
        {
            ...
            StreamReader SR = new StreamReader(FullFileName,Encoding.Unicode);
            if (SR == null)
            {
                return false;
            }
        ...
        public bool WriteToFile()
        {
            ...
            StreamWriter SW = new StreamWriter(mFullFileName, false, Encoding.Unicode);
            for (int i = 0; i < mAppList.Count; i++)
            {
