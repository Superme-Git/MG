...
namespace CSTools
{
    ...
    {
        static public bool ImportTable(ToolsTable TT, string FullFileName, EMXLSReadMode XLSReadMode = EMXLSReadMode.XLSRM_ByNPOI, bool TableOrCode = true, int XLSVersion = 2003)
        {
            ...
            {
                return ToolsTableExcelNPOI.ImportTableNPOI(TT, FullFileName, TableOrCode);
            }
            else
            {
                return ToolsTableExcelNPOI.ImportTableNPOI(TT, FullFileName, TableOrCode);
