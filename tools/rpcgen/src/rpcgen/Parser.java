...
public class Parser implements LineParser {
	...
	public static String IMPORT_BEGIN = "// {{{ RPCGEN_IMPORT_BEGIN";
	public static String IMPORT_END = "// RPCGEN_IMPORT_END }}}";
	public static String DEFINE_BEGIN = "// {{{ RPCGEN_DEFINE_BEGIN";
	public static String DEFINE_END = "// RPCGEN_DEFINE_END }}}";

	public void verify(String info) {
		if (importBeginLine < 0 || defineBeginLine < 0
				|| importBeginLine > defineBeginLine
				|| importBeginLine > lines.size()
				|| defineBeginLine > lines.size())
			throw new RuntimeException(info + " is not a rpcgen file");
	}
