...
//
// summary: ShowRenderer的类型参数
//
#define	ST_SVG  0		// 当前唯一所支持的Show的类型
//#define	ST_SVGZ	1	// 压缩的SVG图像数据，尚未支持
//#define	ST_FLASH  1	// FLASH图像数据，尚未支持
#define	ST_DEFAULT  0	// 缺省类型信息
