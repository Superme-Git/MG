...
// Implementation
	...
	void SetListBoxColumns(int iColumnIndex, bool bSet = true);
...
// Implementation
	...
	CInPlaceListBox* ShowInPlaceListBox(int iRowIndex, int iColumnIndex, CStringList& rComboItemsList, CString& strCurSelecetion);
	...
	bool IsListBox( int iColumnIndex);
...
// Attributes
	...
	CList<int, int>	m_ListBoxColumnsList;
