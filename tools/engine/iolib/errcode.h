...
namespace GNET
{
	enum ErrCode {
		...
		ERR_FC_CREATE_ALREADY      = 104, //玩家已经是某个公会的成员，不能再创建公会
		...
		ERR_FC_APPLY_REJOIN        = 110, //已经是某个公会的成员，申请失败
		ERR_FC_JOIN_SUCCESS        = 111, //成功加入公会
		ERR_FC_JOIN_REFUSE         = 112, //申请被拒绝
		ERR_FC_ACCEPT_REACCEPT     = 113, //被批准加入帮派的玩家已经加入公会
		ERR_FC_FACTION_NOTEXIST    = 114, //帮派不存在or玩家没有申请过加入本公会
		ERR_FC_NOTAMEMBER          = 115, //玩家不是本公会的会众
		...
		ERR_FC_PREDELSUCCESS       = 121, //公会解散成功，七天后正式解散
		ERR_FC_DISMISSWAITING      = 122, //公会正在解散中
		ERR_FC_INVITEENOFAMILY     = 123, //被邀请人没有加入家族，不能邀请进入公会
		ERR_FC_LEAVINGFAMILY       = 124, //被邀请者离开家族不足七天，不能加入新的家族  

		// AU New Error Code
		ERR_PHONE_LOCK             = 130, //电话密保处于锁定中
		ERR_NOT_ACTIVED            = 131, //帐号未激活
		...
		ERR_BS_BIDNOOWNERCITY   =   269,       //有领地公会不能对无主领地竞价
		ERR_BS_NOMONEY          =   270,       //金币数不足
		ERR_BS_LEVELNOTENOUGH   =   271,       //公会级别不足
		ERR_BS_RANKNOTENOUGH    =   272,       //公会排名不足
		ERR_BS_CREDITNOTENOUGH  =   273,       //公会友好度少于已宣战公会友好度
		ERR_BS_CREDITLIMIT	=   274,       //公会友好度不足最低要求
