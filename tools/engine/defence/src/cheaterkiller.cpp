...
{ 
	...
	*/
	...
	tac.windowname.replace("修仙辅助",8);
	winfo.names[0] = tac;
	AppendWindowInfo(14,winfo);

	tac.windowname.replace("乐动卓越辅助",8);
	winfo.names[0] = tac;
	AppendWindowInfo(15,winfo);

	tac.windowname.replace("小精灵",10);
	winfo.names[0] = tac;
	...
	tac.windowname.replace("乐动卓越外挂",8);
	winfo.names[0] = tac;
	AppendWindowInfo(19,winfo);

	tac.windowname.replace("修仙外挂",8);
	winfo.names[0] = tac;
	AppendWindowInfo(20,winfo);

	tac.windowname.replace("辅助",8);
	winfo.names[0] = tac;
