...
class CFileStream : public ZIP::CUncopyableObject
{
private:
	mutable ZIP::CBaseFile&		m_file;

public:
	CFileStream( ZIP::CBaseFile& file);
	virtual ~CFileStream();

	fsize_t Seek( foff_t pos, ZIP::FILE_SEEK_METHOD fsm);
private:
