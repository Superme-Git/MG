...
class CPfsEnvTestCase_Native : public CPPUNIT_NS::TestFixture
{
	CPPUNIT_TEST_SUITE( CPfsEnvTestCase_Native);
...
public:
	CPfsEnvTestCase_Native(void);
	virtual ~CPfsEnvTestCase_Native(void);
