...
// B0xReader.cpp
//
// 从B0x(b00~b04)转换成BMP的实现
//
// 注：
// 对于多块的格式为PIX_FMT_R5G6B5 和 PIX_FMT_R8G8B8的图像来说
// 为了使得缺失块信息的b0x在经过Translator转化后能够原样还原，
// 我们不得不进行填补Alpha通道处理。
// 即，对于任意的b0x类型的文件，经Decoder转化后，结果都是32bit的bmp
//
// author : yanghaibo
// date : 2008-11-20
//
...
my_init_read_b0x (translator_common_ptr cinfo)
{
