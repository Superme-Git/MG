...
BOOL CChildFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	if(!m_wndSplitter1.CreateView(0, 0,
		RUNTIME_CLASS(CDistortionInfoView), CSize(500, 0), pContext))
	{
	...
	if(!m_wndSplitter2.CreateView(0, 0, RUNTIME_CLASS(CDistortionEditorView), CSize(0, prect.bottom-prect.top-20), pContext))
	{
		TRACE0("Failed to create second pane\n");
		return FALSE;
	}
	if(!m_wndSplitter2.CreateView(1, 0, RUNTIME_CLASS(CDistortionStatusView), CSize(0, 0), pContext))
	{
