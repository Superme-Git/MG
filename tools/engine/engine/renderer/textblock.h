#ifndef __Nuclear_TEXTBLOCK_H
#define __Nuclear_TEXTBLOCK_H
...
public:
	...
	virtual void Render( Renderer& renderer, float x, float y, const FRECT* src);
	virtual void Render( Renderer* renderer, const FPOINT& textPos, const FPOINT& fScale, const FRECT* src);
...
private:
	int  FillBitmap();
	void Render( Renderer* renderer, float x, float y, const FRECT* src, DWORD fontColor, DWORD gradualColor, DWORD bkColor);
	void ShadowRender( Renderer* renderer, float x, float y, const FRECT* src, DWORD fontColor, DWORD gradualColor, DWORD bkColor, DWORD shadowColor);
	void StrokeRender( Renderer* renderer, float x, float y, const FRECT* src, DWORD fontColor, DWORD gradualColor, DWORD bkColor, DWORD strokeColor);
