...
namespace Nuclear
{
	...
	//方法们
		static void LoadRegion(XMLIO::CINode& node, RegionSet& regionSet);
		static void SaveRegion(XMLIO::CONode& node, const RegionSet& regionSet);
		static void LoadPolygon(XMLIO::CINode& node, XPPolygon& polygon);
		static void SavePolygon(XMLIO::CONode& node, const XPPolygon& polygon);
		inline static void LoadCircle(XMLIO::CINode& node, XPCircle& circle);
		inline static void SaveCircle(XMLIO::CONode& node, const XPCircle& circle);
	...
	void XPSoundArea::LoadCircle(XMLIO::CINode& node, XPCircle& circle)
	{
	...
	void XPSoundArea::SaveCircle(XMLIO::CONode& node, const XPCircle& circle)
	{
