...
{
	public partial class CFormButtonImage : Form
	{
		private readonly CFormMain m_mainform;
		private readonly CComponentButtonImage m_com;
		...
		public string Image3Name
		{
			...
			set
			{
				...
				{
					MessageBox.Show("设置图片(按下态)失败", "GUIEditor2 - 错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
					value = null;
				}
		...
		public CFormButtonImage(CFormMain mainform, CComponentButtonImage com)
		{
			InitializeComponent();
