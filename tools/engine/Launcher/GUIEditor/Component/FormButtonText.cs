...
{
	public partial class CFormButtonText : Form
	{
		private readonly CFormMain m_mainform;
		private readonly CComponentButtonText m_com;
		...
		public CFormButtonText(CFormMain mainform, CComponentButtonText com)
		{
			InitializeComponent();
