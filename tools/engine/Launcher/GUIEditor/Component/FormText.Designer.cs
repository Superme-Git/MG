namespace GUIEditor2
{
	partial class CFormText
	{
		...
		private void InitializeComponent()
		{
			...
			this.gbScroll.Location = new System.Drawing.Point(8, 334);
			...
			this.rbMultiLine.Text = "多行文本框(垂直滚动条)";
			...
			this.rbRawArea.Text = "原始文本框";
			this.rbRawArea.UseVisualStyleBackColor = true;
			// 
			// cbViewOnly
			// 
			this.cbViewOnly.AutoSize = true;
			this.cbViewOnly.Location = new System.Drawing.Point(15, 465);
			...
			// tbTipInfo
			// 
			this.tbTipInfo.Location = new System.Drawing.Point(81, 483);
			...
			this.lbTipInfo.Location = new System.Drawing.Point(12, 487);
			...
			this.AutoSize = true;
			this.ClientSize = new System.Drawing.Size(210, 514);
