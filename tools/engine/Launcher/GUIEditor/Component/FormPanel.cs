...
{
	public partial class CFormPanel : Form
	{
		private readonly CFormMain m_mainform;
		private readonly CComponentPanel m_com;
		...
		public int Border
		{
			get { int x; return Int32.TryParse(tbBorder.Text, out x) ? x : 0; }
		...
		public CFormPanel(CFormMain mainform, CComponentPanel com)
		{
			InitializeComponent();
		...
		private void cbbScroll_SelectedIndexChanged(object sender, EventArgs e)
		{
			bnImage1.Enabled = (cbbScrollH.Text == "" && cbbScrollV.Text == "");
		}
	}
}
