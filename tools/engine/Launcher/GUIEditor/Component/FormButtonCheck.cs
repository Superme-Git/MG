...
{
	public partial class CFormButtonCheck : Form
	{
		private readonly CFormMain m_mainform;
		private readonly CComponentButtonCheck m_com;
		...
		public CFormButtonCheck(CFormMain mainform, CComponentButtonCheck com)
		{
			InitializeComponent();
