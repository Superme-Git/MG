...
public:
	...
	//
	BOOL GetBitmap( LPCTSTR lpszName, HBITMAP& rBitmap, BOOL bDIB, CRect& rRect);
...
protected:
	...
	HBITMAP _LoadDIBitmap( LPCTSTR lpszFileName );
	...
	//
	BOOL _ParseImageNode(CComPtr<IXMLDOMNode> spImageNode, HBITMAP& rBitmap, BOOL bDIB, CRect& rRect);
