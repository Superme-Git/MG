 ...
 ***************************************************************************/
#ifndef _FalAnimationButton_h_
#define _FalAnimationButton_h_
...
namespace CEGUI
{
    ...
    */
    class FALAGARDBASE_API FalagardAnimationButton : public WindowRenderer
    {
    public:
        ...
        \brief
            Constructor
        */
        FalagardAnimationButton(const String& type);
		FalagardAnimationButton(){}
