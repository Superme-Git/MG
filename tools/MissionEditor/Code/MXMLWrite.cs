...
namespace Knight.MissionEditor
{
   ...
   /************************************************************************/
    ...
    public class MissionInfo : INotifyPropertyChanged
    {
        ...
        //任务自动
        private string strAutoDo;
        [XmlAttribute()]
        public string AutoDo
        {
            get { return strAutoDo; }
            set
            {
                strAutoDo = value;
                if (this.PropertyChanged != null)
                {
                    PropertyChanged.Invoke(this, new PropertyChangedEventArgs("AutoDo"));
                }
            }
        }
    ...
    public class MissionIDOC
    {
        ...
        public override string ToString()
        {
            return 
                ...
                "  任务名称  :" + 
                    EditorApp.GetCurMissionDB().GetMissionNameByID(missionid);
        }
    }
