 ...
 ***************************************************************************/
#ifndef _FalIrregularFigure_h_
#define _FalIrregularFigure_h_
...
namespace CEGUI
{
    ...
    */
    class FALAGARDBASE_API FalagardIrregularFigure : public WindowRenderer
    {
    public:
        ...
        \brief
            Constructor
        */
        FalagardIrregularFigure(const String& type);
		FalagardIrregularFigure(){}
